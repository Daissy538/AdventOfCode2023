...
Console.WriteLine("Answer Day 5 Answer 1: " + result + " - time: " + sw1.ElapsedMilliseconds + "ms");
...
Console.WriteLine("Answer Day 5 Answer 2: " + result2 + " - time: "+ sw2.ElapsedMilliseconds + "ms");